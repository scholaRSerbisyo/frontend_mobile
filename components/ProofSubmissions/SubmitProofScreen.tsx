...
export function SubmitProofScreen({ eventId }: SubmitProofScreenProps) {
  ...
  const handleImageCapture = async (isTimeIn: boolean) => {
    ...
    Alert.alert(
      ...
      `Are you sure you want to capture your ${isTimeIn ? "Time In" : "Time Out"} photo?`,
      [
        {
          text: "Cancel",
          style: "cancel",
  ...
  const handlePhotoConfirm = async (photo: CameraCapturedPicture & { location?: { latitude: number; longitude: number } }) => {
    ...
    if (currentCaptureType === 'timeIn') {
      ...
      Alert.alert("Confirm Time In Submission", "Are you sure you want to submit your Time In?", [
        {
          text: "Cancel",
          style: "cancel",
        },
  ...
  const handleSubmit = async () => {
    if (!isTimeInSubmitted) {
      try {
        Alert.alert("Confirm Time In", "Are you sure you want to submit your Time In?", [
        {
          text: "Cancel",
          style: "cancel",
        },
    ...
    Alert.alert("Confirm Time Out Photo", "Are you sure you want to use this photo for Time Out?", [
      {
        text: "Cancel",
        style: "cancel",
      },
